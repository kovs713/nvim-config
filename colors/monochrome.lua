...
hi('MiniStatuslineModeNormal', { guifg = palette.bg, guibg = '#0087d7', gui = 'bold' })
hi('MiniStatuslineModeInsert', { guifg = palette.bg, guibg = '#44994c', gui = 'bold' })
hi('MiniStatuslineModeVisual', { guifg = palette.bg, guibg = palette.visual, gui = 'bold' })
hi('MiniStatuslineModeReplace', { guifg = palette.bg, guibg = palette.error, gui = 'bold' })
hi('MiniStatuslineModeCommand', { guifg = palette.bg, guibg = '#af5faf', gui = 'bold' })
