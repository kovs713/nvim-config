...
|------|-----|--------|-------------|
| Ⓝ | <kbd>leader</kbd><kbd>s</kbd> | \<cmd>wall\<CR> | Save all buffers |
...
| Mode | Key | Action | Description |
|------|-----|--------|-------------|
| Ⓝ | <kbd>leader</kbd><kbd>r</kbd><kbd>f</kbd> | \<cmd>TSToolsRenameFile\<CR> | TS [R]ename [F]ile + Fix Imports |
| Ⓝ | <kbd>leader</kbd><kbd>o</kbd><kbd>i</kbd> | \<cmd>TSToolsOrganizeImports\<CR> | TS Tools Organize [I]mports |
</details>
<details>
<summary
...
| Mode | Key | Action | Description |
|------|-----|--------|-------------|
| Ⓝ | <kbd>leader</kbd><kbd>r</kbd><kbd>r</kbd> | require('refactoring').select_refactor { prefer_ex_cmd = true } | Refactor… |
| Ⓝ | <kbd>leader</kbd><kbd>r</kbd><kbd>e</kbd> | require('refactoring').refactor 'Extract Function' | Extract Function |
| Ⓝ | <kbd>leader</kbd><kbd>r</kbd><kbd>v</kbd> | require('refactoring').refactor 'Extract Variable' | Extract Variable |
| Ⓝ | <kbd>leader</kbd><kbd>r</kbd><kbd>I</kbd> | require('refactoring').refactor 'Inline Function' | Inline Function |
| Ⓝ | <kbd>leader</kbd><kbd>r</kbd><kbd>i</kbd> | require('refactoring').refactor 'Inline Variable' | Inline Variable |
</details>
<details>
<summary
...
| Ⓥ | <kbd>leader</kbd><kbd>g</kbd><kbd>s</kbd> | gitsigns.stage_hunk { vim.fn.line '.', vim.fn.line 'v' } | [g]it [s]tage hunk |
| Ⓥ | <kbd>leader</kbd><kbd>g</kbd><kbd>r</kbd> | gitsigns.reset_hunk { vim.fn.line '.', vim.fn.line 'v' } | [g]it [r]eset hunk |
| Ⓝ | <kbd>leader</kbd><kbd>g</kbd><kbd>s</kbd> | gitsigns.stage_hunk | [g]it [s]tage hunk |
| Ⓝ | <kbd>leader</kbd><kbd>g</kbd><kbd>r</kbd> | gitsigns.reset_hunk | [g]it [r]eset hunk |
| Ⓝ | <kbd>leader</kbd><kbd>g</kbd><kbd>S</kbd> | gitsigns.stage_buffer | [g]it [S]tage buffer |
| Ⓝ | <kbd>leader</kbd><kbd>g</kbd><kbd>u</kbd> | gitsigns.stage_hunk | [g]it [u]ndo stage hunk |
| Ⓝ | <kbd>leader</kbd><kbd>g</kbd><kbd>R</kbd> | gitsigns.reset_buffer | [g]it [R]eset buffer |
| Ⓝ | <kbd>leader</kbd><kbd>g</kbd><kbd>p</kbd> | gitsigns.preview_hunk | [g]it [p]review hunk |
| Ⓝ | <kbd>leader</kbd><kbd>g</kbd><kbd>b</kbd> | gitsigns.blame_line | [g]it [b]lame line |
| Ⓝ | <kbd>leader</kbd><kbd>g</kbd><kbd>d</kbd> | gitsigns.diffthis | [g]it [d]iff against index |
| Ⓝ | <kbd>leader</kbd><kbd>g</kbd><kbd>D</kbd> | gitsigns.diffthis '@' | [g]it [D]iff against last commit |
| Ⓝ | <kbd>leader</kbd><kbd>t</kbd><kbd>b</kbd> | gitsigns.toggle_current_line_blame | [T]oggle git show [b]lame line |
| Ⓝ | <kbd>leader</kbd><kbd>t</kbd><kbd>D</kbd> | gitsigns.preview_hunk_inline | [T]oggle git show [D]eleted |
</details>
<details>
<summary
...
| Mode | Key | Action | Description |
|------|-----|--------|-------------|
| Ⓝ | <kbd>leader</kbd><kbd>f</kbd><kbd>t</kbd> | \<cmd>TodoFzfLua\<CR> | [F]zfLua [T]odo Comments |
</details>
<details>
<summary
...
| Mode | Key | Action | Description |
|------|-----|--------|-------------|
| - | <kbd>leader</kbd><kbd>?</kbd> | require('which-key').show { global = false } | Buffer Local Keymaps (which-key) |
</details>
<details>
<summary
...
| Mode | Key | Action | Description |
|------|-----|--------|-------------|
| Ⓝ | <kbd>leader</kbd><kbd>o</kbd><kbd>d</kbd> | \<cmd>Obsidian dailies\<cr> | [O]bsidian [D]ailies |
| Ⓝ | <kbd>leader</kbd><kbd>o</kbd><kbd>n</kbd><kbd>t</kbd> | \<cmd>Obsidian today\<cr> | [O]bsidian [N]ew [T]oday |
| Ⓝ | <kbd>leader</kbd><kbd>o</kbd><kbd>n</kbd><kbd>y</kbd> | \<cmd>Obsidian yesterday\<cr> | [O]bsidian [N]ew [Y]esterday |
| Ⓝ | <kbd>leader</kbd><kbd>o</kbd><kbd>n</kbd><kbd>n</kbd> | \<cmd>Obsidian new\<cr> | [O]bsidian [N]ew [N]ote |
| Ⓝ | <kbd>leader</kbd><kbd>o</kbd><kbd>s</kbd> | \<cmd>Obsidian search\<cr> | [O]bsidian [S]earch |
| Ⓝ | <kbd>g</kbd><kbd>f</kbd> | obsidian.util.gf_passthrough() | [G]oto markdown [F]ile |
...
| Mode | Key | Action | Description |
|------|-----|--------|-------------|
| Ⓝ | <kbd>leader</kbd><kbd>l</kbd><kbd>h</kbd> | \<cmd>Lspsaga hover_doc\<CR> | [L]sp [H]over Doc |
| Ⓝ | <kbd>leader</kbd><kbd>l</kbd><kbd>R</kbd> | \<cmd>Lspsaga rename\<CR> | [L]sp [R]ename |
| Ⓝ | <kbd>leader</kbd><kbd>l</kbd><kbd>d</kbd> | \<cmd>Lspsaga peek_definition\<CR> | [L]sp Peek [D]efinition |
| Ⓝ | <kbd>leader</kbd><kbd>[</kbd><kbd>d</kbd> | \<cmd>Lspsaga diagnostic_jump_prev\<CR> | [D]iagnostic next |
| Ⓝ | <kbd>leader</kbd><kbd>]</kbd><kbd>d</kbd> | \<cmd>Lspsaga diagnostic_jump_next\<CR> | [D]iagnostic prev |
| Ⓝ | <kbd>g</kbd><kbd>d</kbd> | \<cmd>Lspsaga goto_definition\<CR> | [G]oto [D]efinition |
| Ⓝ | <kbd>leader</kbd><kbd>l</kbd><kbd>r</kbd> | require('fzf-lua').lsp_references() | [L]sp Peek [R]eferences |
| Ⓝ | <kbd>leader</kbd><kbd>l</kbd><kbd>e</kbd> | lua vim.diagnostic.open_float() | [L]sp Diagnostic Float [E] |
</details>
<details>
<summary
...
| Mode | Key | Action | Description |
|------|-----|--------|-------------|
| Ⓝ | <kbd>leader</kbd><kbd>a</kbd> | harpoon:list():add() | Harpoon [A]dd file |
| Ⓝ | <kbd>leader</kbd><kbd>E</kbd> | harpoon.ui:toggle_quick_menu(harpoon:list()) | Harpoon m[E]nu |
...
| Mode | Key | Action | Description |
|------|-----|--------|-------------|
| Ⓝ | <kbd>leader</kbd><kbd>e</kbd><kbd>f</kbd> | <cmd>Neotree toggle float<CR> | Open Neo-Tree [E]xplorer [F]loating |
| Ⓝ | <kbd>leader</kbd><kbd>e</kbd><kbd>r</kbd> | <cmd>Neotree toggle position=right<CR> | Open Neo-Tree [E]xplorer on the [R]ight |
</details>
<details>
<summary
...
| Mode | Key | Action | Description |
|------|-----|--------|-------------|
| Ⓝ,Ⓥ | <kbd>leader</kbd><kbd>c</kbd><kbd>a</kbd> | require('fzf-lua').lsp_code_actions() | [C]ode [A]ctions |
| Ⓝ,Ⓥ | <kbd>leader</kbd><kbd>l</kbd><kbd>l</kbd> | \<cmd>LspRestart\<CR> | [L][L]sp Restart |
| Ⓝ | <kbd>leader</kbd><kbd>l</kbd><kbd>i</kbd> | require('fzf-lua').lsp_implementations() | [L]sp [I]mplimentations |
</details>
<details>
<summary
...
| Mode | Key | Action | Description |
|------|-----|--------|-------------|
| Ⓝ,Ⓥ | <kbd>leader</kbd><kbd>w</kbd><kbd>e</kbd> | require('nvim-emmet').wrap_with_abbreviation | [W]rap [E]lement |
</details>
